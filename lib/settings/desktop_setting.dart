...
class _DesktopSettingState extends State<DesktopSetting> {
  ...
  getSharedData() async {
    ...
    setState(() {
      ...
      selectedCode = (sharedPreferences.getString('countryCode')!=""?sharedPreferences.getString('countryCode'):selectedCode)!;
      mobileController.text = sharedPreferences.getString('phoneNo')! ?? '';
      ...
      setState(() {
        dropdownItems = countries.map<DropdownMenuItem<String>>((country) {
          return DropdownMenuItem<String>(
            ...
            child: Text('+${country["countryCode"]}',overflow: TextOverflow.ellipsis),
          );
        }).toList();
  ...
  void changePassword(BuildContext context) async {
    ...
    if (currentPasswordController.text.isEmpty) {
      ...
      await EasyLoading.showInfo('Confirm password is different from the new password');
      setState(() {
        _error = true;
      });
      FocusScope.of(context).requestFocus(confirmPasswordFocusNode);
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ListTile(
                                    ...
                                    tileColor: buttonSelected == 'info' ? primaryColor : null,
                                    leading: Icon(
                                      Icons.settings,
                                      color: buttonSelected == 'info' ? iconColor : null,
                                    ),
                                    title: Text(
                                ...
                                Padding(
                                  ...
                                  child: ListTile(
                                    ...
                                    tileColor: buttonSelected == 'passwordScreen' ? primaryColor : null,
                                    leading: Icon(
                                      Icons.password_rounded,
                                      color: buttonSelected == 'passwordScreen' ? iconColor : null,
                                    ),
                                    title: Text(
                                      'Change Password',
                                ...
                                Padding(
                                  ...
                                  child: ListTile(
                                    ...
                                    tileColor: buttonSelected == 'metaDetails' ? primaryColor : null,
                                    leading: Icon(
                                      Icons.contacts,
                                      color: buttonSelected == 'metaDetails' ? iconColor : null,
                                    ),
                                    title: Text(
                                      'Meta Information',
                              ...
                              child: ConstrainedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        MyDropdown(selectedCountryCode:selectedCode,list: dropdownItems,onValueChanged: (String value) {
                                          setState(() {
                                            selectedCode = value;
                                          });
                                        },),
                                        ...
                                        Container(
                                          ...
                                          child: ElevatedButton(
                                            ...
                                            style: ElevatedButton.styleFrom(
                                              backgroundColor: primaryColor, // Set the background color to blue
                                              minimumSize: const Size(100, 50), // Set the minimum width and height of the button
                                              shape: RoundedRectangleBorder(
