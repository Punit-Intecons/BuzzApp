...
class _DesktopCampaignState extends State<DesktopCampaign> {
  ...
  String extractBodyText(lang,type) {
    ...
    if (enComponents != null) {
      ...
      enComponents.firstWhere((component) => component['type'] == type, orElse: () => null);
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: Center(
                            child: Image.network(
                              extractBodyText(lang, "HEADER"), // Replace with the actual image URL
                            ),
                          ),
                        ),
                        Padding(
                      ...
                      child: Row(
                        children: [
                              ...
                              items: metaTemplates != null &&
                                  ...
                                  : [
                                    const DropdownMenuItem<String>(
                                      ...
                                      child: Row(
                                        children: [
                                          Icon(Icons.dvr_sharp, color: Colors.grey), // Add the desired icon
                                          SizedBox(width: 3), // Add spacing between the icon and text
                                          Text(
                                            "Choose Template",
                                            overflow: TextOverflow.ellipsis,
                                            style: TextStyle(
                                                color: Colors.grey,
                                                fontSize: 16.0// Set the text color to gray
                                            ),
                                          ),
                                        ],
                                      ),
                          ...
                          Container(
                            ...
                            child: DropdownButtonFormField<String>(
                              value: selectedLanguage, // Use the selected value variable
                              onChanged: (String? newValue) {
                                setState(() {
                                  selectedLanguage = newValue; // Update the selected value
                                });
                              ...
                              items: dropdownItems.isNotEmpty
                                ...
                                const DropdownMenuItem<String>(
                                  ...
                                  child: Row(
                                    children: [
                                      Icon(Icons.language, color: Colors.grey), // Add the desired icon
                                      SizedBox(width: 3), // Add spacing between the icon and text
                                      Text(
                                        "Choose Language",
                                        overflow: TextOverflow.ellipsis,
